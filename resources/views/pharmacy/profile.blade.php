                ...
                <form id="profileForm" autocomplete="off">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="state" value="{{ old('state', auth()->user()->state ?? '') }}"
                                disabled>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">City</label>
                            <input class="form-control" name="city" value="{{ old('city', auth()->user()->city ?? '') }}" disabled>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Building / House No.</label>
                            <input class="form-control" name="address_building_no"
                                value="{{ old('address_building_no', auth()->user()->address_building_no ?? '') }}" disabled>
                        </div>
