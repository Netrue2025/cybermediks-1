    ...
    <div class="row g-3">
        ...
        <div class="col-lg-8">
            <div class="cardx h-100">
                ...
                <div id="txList">
                    @include('hospital.wallet._list', ['transactions' => $transactions])
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            ...
                            <input type="number" id="wdBankCode" hidden>
                        </div>
                        <div class="col-md-6">
    ...
    <script>
        (function() {
            ...
            function refreshList() {
                $.get(`{{ route('hospital.wallet.index') }}`, {}, function(html) {
            ...
            $('#wdBankName').on('change', function() {
                ...
                // Clear account name if bank changes
