   ...
   <center>
    ...
    <div class="sb-scroll">
        <nav class="menu">
            ...
            <a class="item {{ request()->routeIs('health.dashboard') ? 'active' : '' }}"
                href="{{ route('health.dashboard') }}">
                <i class="fa-solid fa-gauge"></i><span>Dashboard</span>
            </a>

            <a class="item {{ request()->routeIs('health.doctors.index') ? 'active' : '' }}" href="{{ route('health.doctors.index') }}">
    ...
    {{-- Bottom actions --}}
    <div class="sb-bottom">
        <a class="item {{ request()->routeIs('health.profile') ? 'active' : '' }} mb-4" href="{{ route('health.profile') }}">
