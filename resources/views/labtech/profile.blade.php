        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="section-card mb-3">
                ...
                <div class="d-grid gap-2 mt-3">
                    <a href="{{ route('labtech.wallet.index') }}" class="btn btn-gradient">Withdraw Funds</a>
                    <a href="{{ route('labtech.wallet.index') }}" class="btn btn-outline-light">View Transactions</a>
                </div>
            </div>
...
@push('scripts')
    <script>
        ...
        $('#profileForm').on('submit', function(e) {
            ...
            $.post(`{{ route('labtech.profile.update') }}`, $.param(data))
        ...
        $('#passwordForm').on('submit', function(e) {
            ...
            lockBtn($btn);
            $.post(`{{ route('labtech.profile.password') }}`, $(this).serialize())
                .done(res => {
