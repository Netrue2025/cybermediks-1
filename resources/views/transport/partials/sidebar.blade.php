   ...
   <center>
     <div class="sb-user align-items-center gap-3">
        ...
        <div>
            ...
            <div class="sb-role">Department of Pharmacy</div>
        </div>
    </div>
   </center>
    ...
    <div class="sb-scroll">
        <nav class="menu">
            ...
            <a class="item {{ request()->routeIs('transport.dashboard') ? 'active' : '' }}"
                href="{{ route('transport.dashboard') }}">
                <i class="fa-solid fa-gauge"></i><span>Dashboard</span>
            </a>

            <a class="item {{ request()->routeIs('transport.pharmacies.index') ? 'active' : '' }}" href="{{ route('transport.pharmacies.index') }}">
    ...
    {{-- Bottom actions --}}
    <div class="sb-bottom">
        <a class="item {{ request()->routeIs('transport.profile') ? 'active' : '' }} mb-4" href="{{ route('transport.profile') }}">
